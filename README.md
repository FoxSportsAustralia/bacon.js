...
[`Bacon.fromEvent(target, eventName [, optionsOrUseCapture] [, eventTransformer])`](#bacon-fromevent "Bacon.fromEvent(target : EventTarget | EventEmitter, eventName : String [, optionsOrUseCapture : Object | boolean] [, eventTransformer]) : EventStream") creates an EventStream from events
